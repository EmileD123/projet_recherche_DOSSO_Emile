...
def likelihood_func(mat_cov,zHD,CEPH_DIST,MU_SHOES) :
    ...
    for i in range(1701):
        ...
        def f(x):
            return (1/(((1+(0.18)*(1/((1+x))))**(1/2))*(73.6)*((0.334*((1+x)**3)+0.666)**(1/2))))*(3*(10**5))*(10**6) #🔴calcul de la distance lumineuse avec les paramètres cosmologiques FlatLambdaCDM dans Brout et al. 2022 = Analysis on cosmological constraints
